...
class Cart
{
	...
	public static function addProduct($id)
	{
		...
		// Возвращаем количество товаров в корзине (для вывода на странице)
	...
	/**
	 * Возвращает массив (из сессии) с идентификаторами и количеством товаров в корзине<br/>
	...
	{
		// Получаем массив с идентификаторами и количеством товаров в корзине (из сессии)
