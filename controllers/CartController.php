...
class CartController
{
	...
	public function actionAdd($id)
	{
		...
		// в переменную сохраняем адрес страницы с которой пришёл пользователь
		$referrer = $_SERVER['HTTP_REFERER'];
		// и перенаправляем пользователя на эту страницу
	...
	public function actionCheckout()
	{
		...
		if (isset($_POST['submit'])) {
			...
			if (!User::checkPhone($userPhone)) {
				$errors[] = 'Номер телефона должен содержать не менее 10-ти символов';
			}
